...
print(df.sort_index())
print(df.sort_values('hire_date'))
print(df.sort_values('performance_score', ascending=False))
print(df[df['salary'] > 60000])
print(df[df['salary'] < 60000])
print(df[df['performance_score'] > 4.5])
print(df[df['performance_score'] < 4.5])
print(df[df['bonus'] > 6000])
print(df[df['bonus'] < 6000])
print(df[df['hire_date'] > '2020-01-01'])
print(df[df['hire_date'] < '2020-01-01'])
print(df[df['hire_date'] == '2020-01-15'])
print(df[df['hire_date'] != '2020-01-15'])
print(df[df['employee_name'].str.startswith('A')])
print(df[df['employee_name'].str.endswith('e')])
print(df[df['employee_name'].str.contains('a')])