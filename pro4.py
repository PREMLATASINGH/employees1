...
print(df['order_amount'].mode())
print(df['order_amount'].quantile(0.25))
print(df['order_amount'].quantile(0.75))
print(df['order_amount'].max())
print(df['order_amount'].min())
print(df['order_amount'].sum())
print(df['order_amount'].var())
print(df['order_amount'].skew())
print(df['order_amount'].kurt())
print(df['order_amount'].cumsum())
print(df['order_amount'].cummax())
print(df['order_amount'].cummin())
print(df['order_amount'].diff())
print(df['order_amount'].pct_change())
print(df['order_amount'].rolling(window=3).mean())
print(df['order_amount'].rolling(window=3).std())
print(df['tax'].rolling(window=3).mean())
print(df['tax'].median())
print(df['tax'].mode())
print(df['tax'].quantile(0.25))
print(df['tax'].quantile(0.75))
print(df['tax'].max())
print(df['tax'].min())
print(df['tax'].sum())
print(df['tax'].var())